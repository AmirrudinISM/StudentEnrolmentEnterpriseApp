...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item ">
          <a class="nav-link" href="addSubject.jsp">
            <i class="bi bi-grid"></i>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card recent-sales">
                  <div class="card-body">
                    <h5 class="card-title">Course <span>| Enrolled Courses</span></h5>
                    <p>Name : ${name}</p>
                    <p>ID   : ${ID}</p>
                    <p>Email: ${email}</p>
                    <form action="StudentEnrolmentController" method="post" >
                        <div class="form-group col-md-4">
                            ...
                            <select id="inputState" name="selectedCourse" class="form-control">
                                ...
                                <% for(int i = 0; i < courseList.size(); i++){ %>
                                    <option value="<%= courseList.get(i).getCourseID() %>"><%= courseList.get(i).getCourseID() + ", " +courseList.get(i).getCourseTitle() + ", " +courseList.get(i).getCreditHours() %></option>
                                <% } %>
                            </select>
                        </div>
                        <br>
                        <div class="form-group col-md-4">
                            <button type="submit" class="btn btn-primary" name="submit" value="addSubject">Add</button>
                        </div>
                    </form>
                  </div>
                </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-12">
              <div class="card recent-sales">
                <div class="card-body">
                  <h5 class="card-title">Course <span>| Added course</span></h5>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                        <% ArrayList<Enrolment> enrolled = db.getStudentCoursesEnrolledPendingAdd(session.getAttribute("ID").toString()); %>
